...
import CategoryInput from "../../components/admin/pagesListAdmin/CategoryInput";
import AdminPageTitle from "../../components/common/AdminPageTitle";
import MyImageUpload from "../../components/common/form/MyImageUpload";
import MyInput from "../../components/common/form/MyInput";
import { addPage, getSinglePage, updatePage } from "../../services/apiServices";
      ...
      <div className="mt-8">
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <MyAddBtn text="Add Category" onClick={handleAddCategory} />
          </div>
